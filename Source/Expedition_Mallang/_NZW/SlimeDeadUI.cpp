...
{
	//_ UE_LOG(LogTemp, Warning, TEXT("DeadUI SetUpSlimePlayer called. Player=%s"), 
	//_ SlimePlayer ? *SlimePlayer->GetName() : TEXT("NULL"));
...
{
	//_ UE_LOG(LogTemp, Warning, TEXT("OnDead 델리게이트"));
	BP_Dead_UI();
}
